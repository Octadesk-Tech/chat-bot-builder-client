...
export const CreateTicketIcon = (props: any) => (
  <svg width="16" height="12" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15.5 4.5V1.5C15.5 1.10218 15.342 0.720644 15.0607 0.43934C14.7794 0.158035 14.3978 0 14 0H2C1.60218 0 1.22064 0.158035 0.93934 0.43934C0.658035 0.720644 0.5 1.10218 0.5 1.5V4.5C0.897825 4.5 1.27936 4.65804 1.56066 4.93934C1.84196 5.22064 2 5.60218 2 6C2 6.39782 1.84196 6.77936 1.56066 7.06066C1.27936 7.34196 0.897825 7.5 0.5 7.5V10.5C0.5 11.325 1.175 12 2 12H14C14.825 12 15.5 11.325 15.5 10.5V7.5C14.675 7.5 14 6.825 14 6C14 5.175 14.675 4.5 15.5 4.5ZM14 3.405C13.1075 3.9225 12.5 4.8975 12.5 6C12.5 7.1025 13.1075 8.0775 14 8.595V10.5H2V8.595C2.8925 8.0775 3.5 7.1025 3.5 6C3.5 4.875 2.9 3.9225 2 3.405V1.5H14V3.405ZM7.25 8.25H8.75V9.75H7.25M7.25 5.25H8.75V6.75H7.25M7.25 2.25H8.75V3.75H7.25V2.25Z" fill="#067E88" />
  </svg>
)
